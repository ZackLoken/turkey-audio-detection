...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_index.add_argument("--prime-before", type=float, default=30.0)
    p_index.add_argument("--prime-after", type=float, default=180.0)
    ...
    p_run_all.add_argument("--prime-before", type=float, default=30.0)
    p_run_all.add_argument("--prime-after", type=float, default=180.0)
