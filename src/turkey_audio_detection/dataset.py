...
Classes are sex only (Tom/Hen). Region geometry and mel/target construction
live in `sed_data.py`; this module holds the small pieces reused across
stages.
"""
...
def parse_regions(regions_json: object) -> list[dict]:
    """Parse a regions_json cell into a list of region dicts (tolerant of
    NaN/blank).
    """
